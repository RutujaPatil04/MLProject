...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        try:
            ...
            logging.info(f"categorical columns standard scaling completed: {numerical_columns}")
    ...
    def initiate_data_transformation(self,train_path,test_path):
        try:
            ...
            logging.info("Reading testdata completed")
            ...
            logging.info("saved preprocessing obj completed")
            save_object(
